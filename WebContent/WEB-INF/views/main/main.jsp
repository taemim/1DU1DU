        ...
        <div class="accordion accordion-flush" id="accordionFlushExample">
            <div class="accordion-item">
                ...
                <div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne"
                    ...
                    <div class="accordion-body">
                        <br>
                        1DU1DU는 입력해두신 커피 취향에 맞춰 매달 새로운 로스터리 브랜드의 커피들로 라인업이 구성되기 때문에 매달 질릴 틈 없이 새로운 구성으로 즐기실 수
                        있습니다.<br><br>
                    </div>
                </div>
            </div>
            <div class="accordion-item">
                ...
                <div id="flush-collapseTwo" class="accordion-collapse collapse" aria-labelledby="flush-headingTwo"
                    ...
                    <div class="accordion-body">
                        <br>
                        1DU1DU의 원두는 아래와 같은 과정을 거쳐 전달하는 것을 원칙으로 하고 있습니다.<br>
            ...
            <div class="accordion-item">
                ...
                <div id="flush-collapseThree" class="accordion-collapse collapse" aria-labelledby="flush-headingThree"
                    ...
                    <div class="accordion-body">
                        <br>
                        A. 1DU1DU는 매달 16일~다음달 1일 신청자의 경우 2일 정기결제,
                        2일~15일 신청자의 경우 16일 정기결제가 진행됩니다.<br>
                        (정기결제 회사 명 : 주식회사 원두데이볶나)
                        <br><br>
            ...
            <div class="accordion-item">
                ...
                <div id="flush-collapseFive" class="accordion-collapse collapse" aria-labelledby="flush-headingFive"
                    ...
                    <div class="accordion-body">
                        <br>
                        제품 하자 등으로 인해 교환/환불이 필요한 경우 반송비 등 비용은 1DU1DU가 부담하고 있습니다.<br>
